...
fn main() {
    ...
    match manager.set_secret("example_api_key", api_key) {
    ...
    match manager.get_secret("example_api_key") {
        Ok(retrieved_key) => {
    ...
    match manager.set_secret("example_api_key", new_api_key) {
    ...
    match manager.delete_secret("example_api_key") {
