...
#[test]
fn test_envelope_verification_success() {
    ...
    assert!(result.is_err(), "Should fail with mismatched signature");
}

#[test]
fn test_envelope_expired_timestamp() {
    use ed25519_dalek::{Signer, SigningKey};
...
#[test]
fn test_envelope_nonce_replay_prevention() {
    use ed25519_dalek::{Signer, SigningKey};
    use std::time::{SystemTime, UNIX_EPOCH};
    ...
    let _ = crypto.verify_envelope(&envelope);
...
#[test]
fn test_envelope_future_timestamp() {
    use ed25519_dalek::{Signer, SigningKey};
    use std::time::{SystemTime, UNIX_EPOCH};
...
#[test]
fn test_envelope_within_valid_window() {
    use ed25519_dalek::{Signer, SigningKey};
    use std::time::{SystemTime, UNIX_EPOCH};
